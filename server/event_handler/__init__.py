...
from . import (
    ...
    post_moment, get_moments,like_moment, comment_moment,
    voice_call_request, voice_call_response, 
    voice_call_hangup, voice_data,
...
event_handler_map = {
    ...
    MessageType.post_moment: post_moment.run,
    MessageType.get_moments: get_moments.run,
    MessageType.like_moment: like_moment.run,
    MessageType.comment_moment: comment_moment.run,
    # 【新增】
